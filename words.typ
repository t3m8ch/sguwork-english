...
+ *greet* -- поздравлять, приветствовать
+ *candles* -- свечи
+ *such as ...* -- такой, как ...
+ *part* -- район
+ *though* -- однако, хотя
+ *apply* -- подавать какие-то документы, применить
+ *except* -- принять
+ *get* -- получать (более разговорное + имеет много значений помимо этого)
+ *receive* -- получать (более формальное)
+ *day off* -- выходной
+ *everyone* -- все
+ *hope* -- надеяться
+ *swim* -- плавать
+ *swimathon* -- заплыв, плавательный марафон
+ *nurse* -- медсестра
+ *thousands* -- тысячи
+ *letter* -- письмо, буква
+ *thank* -- поблагодарить
...
+ *autumn* -- осень -- /'ɔː təm/
+ *hang on* -- подожди
+ *come round* -- прийти, заехать в гости
+ *What a shame* -- как жаль
+ *Unfortunately* -- к сожалению
+ *offer* -- предложение какой-либо услуги -- /'ɒfə/
+ *suggestion* -- предложение что-либо сделать -- /sə'dʒɛstʃən/
+ *carry* -- нести, приносить -- /'kæɹ.ɪ/
+ *walk* -- /wɔː k/
+ *worry* -- беспокоиться -- /'wɜː ri/
+ *promise* -- /'pɹɒmɪs/
+ *be late* -- опоздать
+ *at my flat* -- ко мне в квартиру
+ *book* -- бронировать
